...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Hermes moderno - alto contraste, paleta profissional",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Bem-vindo ao Hermes Agent. Digite sua mensagem ou /help para comandos.",
            "goodbye": "Ate logo!",
            "response_label": " Hermes ",
            "prompt_symbol": ">",
            "help_header": "Comandos Disponiveis",
        },
        "tool_prefix": "|",
    },
    "ares": {
