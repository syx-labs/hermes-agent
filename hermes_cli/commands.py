...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("goal", "Set a standing goal Hermes works on across turns until achieved", "Session",
               args_hint="[text | draft <text> | show | gate add <cmd> | pause | resume | clear | status | wait <pid> | unwait | structured | round | evidence | decision | reviewer | report]",
               subcommands=("status", "pause", "resume", "clear", "show", "draft", "wait", "unwait", "gate", "structured", "round", "evidence", "decision", "reviewer", "report"),
