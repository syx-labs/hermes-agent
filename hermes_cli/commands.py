...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("goal", "Set a standing goal Hermes works on across turns until achieved", "Session",
               args_hint="[text | draft <text> | show | pause | resume | clear | status | wait <pid> | unwait | structured | round | evidence | decision | reviewer | report]",
               subcommands=("status", "pause", "resume", "clear", "show", "draft", "wait", "unwait", "structured", "round", "evidence", "decision", "reviewer", "report")),
