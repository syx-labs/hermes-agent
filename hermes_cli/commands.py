...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("jobs", "Show scheduled cron jobs and quick actions", "Session",
               gateway_only=True, args_hint="[run|pause|resume|edit] [job_id]"),
    CommandDef("projects", "Show recurring projects and quick actions", "Session",
               gateway_only=True, args_hint="[continue|inspect|review|diagram|handoff] [project]"),
    CommandDef("newtask", "Start a guided task creation flow", "Session",
               gateway_only=True, args_hint="[type|mode|agent|deliverable|confirm] [choice]"),
    CommandDef("research", "Start a guided research request", "Session",
               gateway_only=True, args_hint="[depth|output|artifact|topic|confirm] [choice]"),
    CommandDef("review", "Start a guided code review request", "Session",
               gateway_only=True, args_hint="[scope|checks|runner|output|target|confirm] [choice]"),
