...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("goal", "Set a standing goal Hermes works on across turns until achieved", "Session",
               args_hint="[text | pause | resume | clear | status | structured | round | evidence | decision | reviewer | report]",
               subcommands=("status", "pause", "resume", "clear", "structured", "round", "evidence", "decision", "reviewer", "report")),
